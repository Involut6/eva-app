        ...
        <div class="w-full h-fit xl:p-[30px] max-[1300px]:p-4  max-[741px]:p-0">
            <div class="hidden md:flex flex-col md:flex-row md:flex gap-4 text-white xl:gap-12 mb-10">
                ...
                <div class="p-4 rounded-md bg-gradient-to-r from-[#0000fe] to-[#d0edfe] w-full h-[120px] relative">
                    ...
                    <div>
                        <p class="bg-[#99ff00] w-fit px-6 flex items-center h-full rounded-l-[100%] rounded-r-[20%] absolute right-0 top-0"><svg xmlns="http://www.w3.org/2000/svg" width="55" height="55" viewBox="0 0 24 24"><path fill="currentColor" d="M16 14q-1.25 0-2.125-.875T13 11q0-1.25.875-2.125T16 8q1.25 0 2.125.875T19 11q0 1.25-.875 2.125T16 14Zm-6 6v-1.9q0-.525.25-1t.7-.75q1.125-.675 2.388-1.012T16 15q1.4 0 2.663.338t2.387 1.012q.45.275.7.75t.25 1V20H10Zm-7-6v-2h8v2H3Zm0-8V4h12v2H3Zm8.1 4H3V8h9q-.35.425-.563.925T11.1 10Z"/></svg></p>
                    </div>
                </div>
            </div>
            ...
            <!-- <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 xl:gap-6">
                ...
                <div class="flex bg-white w-full justify-between p-4 gap-6 rounded-md shadow-md relative">
                    ...
                    <div v-if="drop === i.id" class="bg-white shadow-xl border-2 w-[165px] absolute py-2 z-20 rounded-md right-[1.2rem] top-[3rem]">
                        <router-link to="/client" class="hover:bg-gray-200 cursor-pointer"><p class="p-2">View Details</p></router-link>
