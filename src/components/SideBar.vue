    ...
    <div>
        <div class="bg-[#009efb] hidden lg:block py-8 h-screen overflow-hidden">
            ...
            <div class="flex flex-col gap-2 text-lg">
                <router-link to="/" :class="$route.path === '/' ? 'bg-[whitesmoke] text-[#009EFB]' : 'text-white'" class="flex gap-4 items-center cursor-pointer hover:bg-white hover:text-[#009EFB] text-white px-[1.4rem] py-2 text-white">
                ...
                <router-link :to="{name: 'Add-sample'}" :class="$route.path === '/add-sample' ? 'bg-[whitesmoke] text-[#009EFB]' : 'text-white'" class="flex gap-4 items-center cursor-pointer hover:bg-white hover:text-[#009EFB] text-white px-[1.4rem] py-2 text-white">
